...
#include "vector"
  ...
  std::vector<std::vector<std::vector<unsigned int>>>* m_particleId = new std::vector<std::vector<std::vector<unsigned int>>>;

  /// number of all states
  unsigned int m_state_nStates{0};
  /// number of states with measurements
  unsigned int m_state_nMeasurements{0};
  /// volume identifier
  ...
  /// track state type
  std::vector<int>* m_stateType = new std::vector<int>;
...
void SetStatesBranchAddresses(TTree* m_outputTree){
  ...
  m_outputTree->SetBranchAddress("event_nr", &m_state_eventNr);
  ...
  m_outputTree->SetBranchAddress("nStates", &m_state_nStates);
  m_outputTree->SetBranchAddress("nMeasurements", &m_state_nMeasurements);
  ...
  m_outputTree->SetBranchAddress("stateType", &m_stateType);
